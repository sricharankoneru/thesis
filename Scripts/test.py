...
checkpoint_path = os.path.join(curr_path, 'Thesis/mk9ju2gw/checkpoints/epoch=47-step=15600.ckpt')
checkpoint = torch.load(checkpoint_path)  

model = DeepLab("DeepLabV3Plus", "resnet101", "imagenet", in_channels=3, out_classes=1)
